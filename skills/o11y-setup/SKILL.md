---
name: o11y-setup
description: Sets up O11y Engineer module in a project. Use when the user requests to 'install o11y module', 'configure O11y Engineer', or 'setup O11y Engineer'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/o11y/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code o11y
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code o11y --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
